...
__Important__: The __shredder__ API is still maturing as we continue to learn and improve. Please see `?shredder::lifecycle` for the list of functions that are considered stable.
